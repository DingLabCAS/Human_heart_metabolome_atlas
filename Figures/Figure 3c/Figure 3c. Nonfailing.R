...
bed_all <-  read.table("Nonfailing.heart-all.bed.txt", header = T)
pos_bed_uniq <- read.table("Nonfailing.heart-all.pos.txt", header = T, colClasses=c("character", "numeric", "numeric", "character", "character","character", "numeric"))


circos.clear()  
out_file <- "Nonfailing.heart.circ.pdf"
